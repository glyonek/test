...
void UpDownEnterKey()       //перенести в прерівание!!!
{
 ...
 {  
    ...
    // Go to Options menu
    if((enter>GO_TO_OPTIONS)&(PositionPointer==LAST_MODE_MENU)){PositionPointer=FIRST_OPTION_MENU;enter=2;LCD_Clear();KilkistZapuskiv=KilkistZapuskiv_EEP;}; //в меню kilkistzap obnovlyaem !
